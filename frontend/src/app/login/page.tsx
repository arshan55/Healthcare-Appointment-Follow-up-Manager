  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg)] px-6 py-10">
      <div className="animate-fade-up w-full max-w-md rounded-[var(--radius)] border border-[var(--line)] bg-[var(--surface)] p-8 shadow-[var(--shadow-md)]">
        ...
        <h1 className="mt-6 text-3xl text-[var(--ink)]">Sign in</h1>
        <p className="mt-2 text-sm font-medium text-[var(--muted)]">Enter your credentials to access your portal.</p>
      ...
      <p className="mt-4 text-center text-xs text-[var(--muted)]">
        New users are registered as patients by default. Admins can promote accounts to doctor or staff.
      </p>
